...
def create_dummy_user():
    ...
    - full_name: 'test'
    - phone: '764858569' (valid 10-digit phone number)
    - password: '4858'
    """
    try:
        ...
        with app.app_context():
            ...
            existing_user = User.query.filter_by(phone='764858569').first()
            if existing_user:
                print("User with phone '764858569' already exists!")
